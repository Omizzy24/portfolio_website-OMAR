...
const Hero = () => (
  <Section row nopadding>
    <LeftSection>
      ...
      <SectionText>
        &emsp; Here you will be able to find my work and achievements that I have accomplished throughout my career.<br />
        &emsp; I am a recent graduate from the University of Connecticut, with two Bachelor of Science degrees in Microbiology and Economics, as well as a Masters in Quantitative Economics,
        with an interest in Data Science and Software Enginnering. <br/>
        &emsp; I am currently a Senior Analyst at Cigna, being apart of the TECDP program. <br/>
      </SectionText>
...
type = "button"
onclick = "\window.open('https://docs.google.com/document/d/1Uxj_eEkVAfCw3cmi2A1jucku6oNh8hIt/edit?usp=sharing&ouid=107957855563689793858&rtpof=true&sd=true')
</Button>  */}
